...
import { getChatModel } from "@/features/ai/utils/getModel";
...
export async function POST(req: Request) {
    ...
    const result = streamText({
        ...
        system: conversation.systemPrompt ?? "You are PersonalGPT , a helpful assistant", // TODO- enhance System prompt
